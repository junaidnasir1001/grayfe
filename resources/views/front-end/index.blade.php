                ...
                <div id="rev_slider_1" class="rev_slider" data-version="5.4.5">
                    <ul>
                        ...
                        <li data-transition="random" data-masterspeed="1000">
                            ...
                            <img src="{{ asset('front-end/images/slider/banner3.webp') }}" alt="Sky" class="rev-slidebg">
                        ...
                        <li data-transition="random" data-masterspeed="1000">
                            <!-- SLIDE'S MAIN BACKGROUND IMAGE -->
                            <img src="{{ asset('front-end/images/slider/banner4.webp') }}" alt="Sky" class="rev-slidebg">
                            <div class="tp-caption tp-resizeme normalWraping layer_1"
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-sm-6 col-md-6">
                        <div class="ab_img1">
                            <img src="{{ asset('front-end/images/home_1/best1.png') }}" alt=""/>
                        </div>
                        <div class="ab_img2">
                            <img src="{{ asset('front-end/images/home_1/best2.png') }}" alt=""/>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <div class="videoWrap">
                            <img src="{{ asset('front-end/images/home_1/video0.png') }}" alt="">
                ...
                <div class="row">
                    <div class="col-lg-4 col-sm-6 col-md-4">
                        <div class="singlefolio">
                            <img src="{{ asset('front-end/images/portfolio/1.jpg') }}" alt=""/>
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-4">
                        <div class="singlefolio">
                            <img src="{{ asset('front-end/images/portfolio/2.jpg') }}" alt=""/>
                            <div class="folioHover">
                                <a class="cate" href="#">Graphic</a>
                                <h4><a href="portfolio_detail.html">Design Styles</a></h4>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-4">
                        <div class="singlefolio">
                            <img src="{{ asset('front-end/images/portfolio/3.jpg') }}" alt=""/>
                            <div class="folioHover">
                                <a class="cate" href="#">Graphic</a>
                                <h4><a href="portfolio_detail.html">Design Styles</a></h4>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-4">
                        <div class="singlefolio">
                            <img src="{{ asset('front-end/images/portfolio/4.jpg') }}" alt=""/>
                            <div class="folioHover">
                                <a class="cate" href="#">Graphic</a>
                                <h4><a href="portfolio_detail.html">Design Styles</a></h4>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-4">
                        <div class="singlefolio">
                            <img src="{{ asset('front-end/images/portfolio/5.jpg') }}" alt=""/>
                            <div class="folioHover">
                                <a class="cate" href="#">Graphic</a>
                                <h4><a href="portfolio_detail.html">Design Styles</a></h4>
                            </div>
                    ...
                    <div class="col-lg-4 col-sm-6 col-md-4">
                        <div class="singlefolio">
                            <img src="{{ asset('front-end/images/portfolio/6.jpg') }}" alt=""/>
                            <div class="folioHover">
                                <a class="cate" href="#">Graphic</a>
                                <h4><a href="portfolio_detail.html">Design Styles</a></h4>
                            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12">
                        <div class="CL_content">
                            <img src="{{ asset('front-end/images/home_1/trust0.png') }}" alt="">
                            <div class="abc_inner">
                                <div class="row">
